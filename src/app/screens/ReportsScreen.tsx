...
const EXPENSE_APR: CatData[] = [
  {
    id:"invest", name:"Investments", emoji:"📈", color:"#7C5CFF",
    amount:71323, percentage:44.3, trend:+15.0,
    subs:[
      {id:"mf",   name:"Mutual Funds",   emoji:"📉", color:"#9D7EFF", amount:35000, percentage:49.1},
      {id:"stk",  name:"Stocks",         emoji:"📊", color:"#7C5CFF", amount:20000, percentage:28.0},
      {id:"fd",   name:"Fixed Deposit",  emoji:"🏦", color:"#5A3FD8", amount:10000, percentage:14.0},
      {id:"gold", name:"Digital Gold",   emoji:"🪙", color:"#845EC2", amount:6323,  percentage:8.9 },
    ],
  },
  {
    id:"debts", name:"Debts", emoji:"💳", color:"#F7931A",
    amount:44600, percentage:27.7, trend:0,
    subs:[
      {id:"hloan", name:"Home Loan",     emoji:"🏠", color:"#FF9F43", amount:25000, percentage:56.1},
      {id:"cloan", name:"Car Loan",      emoji:"🚗", color:"#F7931A", amount:12000, percentage:26.9},
      {id:"ploan", name:"Personal Loan", emoji:"💸", color:"#D4720A", amount:7600,  percentage:17.0},
    ],
  },
  {
    id:"household", name:"Household", emoji:"🏠", color:"#FFB703",
    amount:22500, percentage:14.0, trend:+7.1,
    subs:[
      {id:"rent",     name:"Home Rent",   emoji:"🏠", color:"#FFC94A", amount:12000, percentage:53.3},
      {id:"electric", name:"Electricity", emoji:"⚡", color:"#FFB703", amount:5500,  percentage:24.4},
      {id:"maintain", name:"Maintenance", emoji:"🔧", color:"#DB9D00", amount:5000,  percentage:22.2},
    ],
  },
  {
    id:"gifts", name:"Gifts", emoji:"🎁", color:"#F72585",
    amount:10000, percentage:6.2, trend:-33.3,
    subs:[
      {id:"fgifts",  name:"Family Gifts",  emoji:"👨‍👩‍👧", color:"#FF5FA0", amount:6000, percentage:60.0},
      {id:"frgifts", name:"Friends Gifts", emoji:"🧑‍🤝‍🧑", color:"#F72585", amount:4000, percentage:40.0},
    ],
  },
  {
    id:"apparel", name:"Apparel", emoji:"👕", color:"#4895EF",
    amount:8800, percentage:5.5, trend:+35.4,
    subs:[
      {id:"cloth", name:"Clothing",     emoji:"👗", color:"#5BA3F5", amount:5500, percentage:62.5},
      {id:"acc",   name:"Accessories",  emoji:"👜", color:"#4895EF", amount:3300, percentage:37.5},
    ],
  },
  {
    id:"food", name:"Food & Dining", emoji:"🍽️", color:"#FF6B35",
    amount:3904, percentage:2.4, trend:-27.7,
    subs:[
      {id:"rest", name:"Restaurants", emoji:"🍴", color:"#FF8C5A", amount:2000, percentage:51.2},
      {id:"groc", name:"Groceries",   emoji:"🛒", color:"#FF6B35", amount:1904, percentage:48.8},
    ],
  },
];
...
const INCOME_APR: CatData[] = [
  {
    ...
    amount:325000, percentage:72.9, trend:0,
    subs:[
      {id:"hsal", name:"Husband Salary", emoji:"👨", color:"#4ADE80", amount:200000, percentage:61.5},
      {id:"wsal", name:"Wife Salary",    emoji:"👩", color:"#22C55E", amount:125000, percentage:38.5},
    ],
  },
  {
    id:"biz-in", name:"Business Income", emoji:"🏢", color:"#7C5CFF",
    amount:90000, percentage:20.2, trend:+8.0,
    subs:[
      {id:"sales",   name:"Sales Revenue",   emoji:"📢", color:"#9D7EFF", amount:60000, percentage:66.7},
      {id:"clients", name:"Client Payments", emoji:"💰", color:"#7C5CFF", amount:30000, percentage:33.3},
    ],
  },
  {
    id:"rental", name:"Rental Income", emoji:"🏡", color:"#F7931A",
    amount:25000, percentage:5.6, trend:0,
    subs:[
      {id:"hrent", name:"House Rent", emoji:"🏢", color:"#FF9F43", amount:20000, percentage:80.0},
      {id:"srent", name:"Shop Rent",  emoji:"🏬", color:"#F7931A", amount:5000,  percentage:20.0},
    ],
  },
  {
    id:"interest", name:"Interest Income", emoji:"📈", color:"#2EC4B6",
    amount:6000, percentage:1.3, trend:+5.0,
    subs:[
      {id:"bint", name:"Bank Interest",       emoji:"🏦", color:"#4AD9CC", amount:4500, percentage:75.0},
      {id:"iint", name:"Investment Interest", emoji:"📊", color:"#2EC4B6", amount:1500, percentage:25.0},
    ],
  },
];
...
const EXPENSE_MAR: CatData[] = [
  {...EXPENSE_APR[0], amount:62000,  percentage:40.1},
  {...EXPENSE_APR[1], amount:44600,  percentage:28.9},
  {...EXPENSE_APR[2], amount:21000,  percentage:13.6},
  {...EXPENSE_APR[3], amount:15000,  percentage:9.7 },
  {...EXPENSE_APR[4], amount:6500,   percentage:4.2 },
  {...EXPENSE_APR[5], amount:5400,   percentage:3.5 },
];
const INCOME_MAR: CatData[] = [
  {...INCOME_APR[0], amount:325000, percentage:76.3},
  {...INCOME_APR[1], amount:83000,  percentage:19.5},
  {...INCOME_APR[2], amount:15000,  percentage:3.5 },
  {...INCOME_APR[3], amount:2700,   percentage:0.7 },
];
...
export function ReportsScreen() {
  ...
  const mainData   = chartType === "expense" ? EXPENSE_APR : INCOME_APR;
  const compareData= chartType === "expense" ? EXPENSE_MAR : INCOME_MAR;

  // Drilldown: show sub or main
  const displayData: (CatData | SubData)[] = drillCat ? drillCat.subs : mainData;

  const totalIncome  = INCOME_APR.reduce((s, c) => s + c.amount, 0);
  const totalExpense = EXPENSE_APR.reduce((s, c) => s + c.amount, 0);
  const ratioPercent = Math.round((totalExpense / totalIncome) * 100);
  ...
  return (
    <div className="relative pb-32"
      ...
      {!isEmpty ? (
        ...
        // Empty state
        <div className="flex flex-col items-center justify-center py-16 gap-4 mx-4">
          <div className="w-20 h-20 rounded-3xl flex items-center justify-center text-4xl"
            style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
            📊
          </div>
          <p className="text-white font-bold" style={{ fontSize: 16 }}>No data yet</p>
          <p className="text-white/38 text-center" style={{ fontSize: 13 }}>
        ...
        <div className="px-4 mb-3">
          <div className="flex items-center justify-between py-3 px-4 rounded-2xl"
            ...
            <div className="flex items-center gap-2.5">
              <BarChart2 className="w-4 h-4 text-white/45" />
              <p className="text-white/65 font-medium" style={{ fontSize: 13 }}>Compare with last month</p>
            </div>
